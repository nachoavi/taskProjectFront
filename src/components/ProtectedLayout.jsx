  ...
  return (
    <div className="app-layout">
      <header className="app-header">
        ...
        <div className={`header-nav-mobile ${menuOpen ? 'open' : ''}`} onClick={(e) => e.target === e.currentTarget && setMenuOpen(false)}>
          <div className="nav-panel">
            ...
            {isAdmin && (
              <>
                <div className="nav-divider"></div>
                <Link to="/admin/tasks" className={`nav-link ${isActive('/admin/tasks') ? 'active' : ''}`} onClick={() => setMenuOpen(false)}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <rect x="3" y="3" width="7" height="7"/>
                    <rect x="14" y="3" width="7" height="7"/>
                    <rect x="14" y="14" width="7" height="7"/>
                ...
                <Link to="/admin/users" className={`nav-link ${isActive('/admin/users') ? 'active' : ''}`} onClick={() => setMenuOpen(false)}>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/>
                    <circle cx="9" cy="7" r="4"/>
                    <path d="M23 21v-2a4 4 0 00-3-3.87"/>
